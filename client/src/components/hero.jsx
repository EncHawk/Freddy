...
export const Hero = ()=>{
    ...
    return(
        <div className='flex flex-col mt-20 sm:mt-28 md:mt-35 mb-8 sm:mb-12 md:mb-15 py-4 px-4 sm:px-6 md:px-2 gap-2 sm:gap-3 justify-center items-center text-black'>
             <div className='bg-neutral-300 dark:bg-neutral-700 py-px px-2 rounded-full text-black dark:text-white/90 border-r-0 border-l-0
             text-xs font-inter transition-all duration-300font-medium md:font-semibold cursor-pointer md:py-2 md:px-2
            ...
            <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-md text-center max-w-[95%] 
            sm:max-w-3xl md:max-w-200 leading-tight sm:leading-20 tracking-tightest px-2
            dark:text-white
            '>
                Meet
                <span className=' mx-1 sm:mx-2 px-2 sm:px-3 relative bg-black/10 dark:bg-neutral-500/20 font-faulty
            ...
            <p className='text-center text-neutral-500 dark:text-neutral-300 font-sm text-sm sm:text-base md:text-xla mb-2 sm:mb-3 tracking-wide max-w-[90%] sm:max-w-2xl px-2'>
                Get notified when an issue is created. 
                <br className='hidden sm:block'/>
                <span className='block sm:inline'>Up your Open Source game today!</span>
            </p>
            <button className='bg-transparent cursor-pointer border-[0.5px] dark:border-neutral-500 dark:text-white border-black rounded-full
                hover:border-orange-400 transition duration-150 py-px px-2 sm:py-2 sm:px-6 text-sm sm:text-base border-r-0 border-l-0 overflow-hidden'>
